...
public class Castle extends PieceAnimation 
{
    ...
    protected void loadAnim()
    {
        ...
        attackNode = (Node)assetManager.loadModel("Models/Animations/castleAttack01/castleAttack.j3o");
        
        deathNode = (Node)assetManager.loadModel("Models/Animations/castleDeath01/castleDeath.j3o");
        
        standNode = (Node)assetManager.loadModel("Models/Animations/castleStand01/castleStand.j3o");
        
        walkNode = (Node)assetManager.loadModel("Models/Animations/castleWalk01/castleWalk.j3o");
    }
