...
public class Queen extends PieceAnimation 
{
    ...
    protected void loadAnim()
    {
        ...
        attackNode = (Node)assetManager.loadModel("Models/Animations/Magical/queenAttack01/queenAttack.j3o");
        
        deathNode = (Node)assetManager.loadModel("Models/Animations/Magical/queenDeath01/queenDeath.j3o");
        
        standNode = (Node)assetManager.loadModel("Models/Animations/Magical/queenStand01/queenStand.j3o");
        
        walkNode = (Node)assetManager.loadModel("Models/Animations/Magical/queenWalk01/queenWalk.j3o");
    }
