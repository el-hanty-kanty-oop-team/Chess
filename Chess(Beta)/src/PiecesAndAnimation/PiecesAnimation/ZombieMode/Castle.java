...
public class Castle extends PieceAnimation 
{
    ...
    protected void loadAnim()
    {
        ...
        attackNode = (Node)assetManager.loadModel("Models/Animations/Zombie/castleAttack01/castleAttack.j3o");
        
        deathNode = (Node)assetManager.loadModel("Models/Animations/Zombie/castleDeath01/castleDeath.j3o");
        
        standNode = (Node)assetManager.loadModel("Models/Animations/Zombie/castleStand01/castleStand.j3o");
        
        walkNode = (Node)assetManager.loadModel("Models/Animations/Zombie/castleWalk01/castleWalk.j3o");
    }
    
    @Override
    protected void loadTexture()
    {
        Texture texture = assetManager.loadTexture("Textures/Animations/Zombie/castle/castle_diffuse.png");
        if(!good)
            texture = assetManager.loadTexture("Textures/Animations/Zombie/castle/castle_diffuse(evil).png");
    ...
    public boolean isEquale(Spatial selectedObject)
    {
        ...
        return selectedObject == (Spatial)standNode.getChild("castleStand");
    }
