...
public class Bishop extends PieceAnimation
{
    ...
    protected void loadAnim()
    {
        ...
        attackNode = (Node)assetManager.loadModel("Models/Animations/Zombie/bishopAttack01/bishopAttack.j3o");
        
        deathNode = (Node)assetManager.loadModel("Models/Animations/Zombie/bishopDeath01/bishopDeath.j3o");
        
        standNode = (Node)assetManager.loadModel("Models/Animations/Zombie/bishopStand01/bishopStand.j3o");
        
        walkNode = (Node)assetManager.loadModel("Models/Animations/Zombie/bishopWalk01/bishopWalk.j3o");
