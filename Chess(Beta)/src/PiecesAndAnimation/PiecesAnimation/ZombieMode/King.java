...
public class King extends PieceAnimation
{
    ...
    protected void loadAnim()
    {
        ...
        attackNode = (Node)assetManager.loadModel("Models/Animations/Zombie/kingAttack01/kingAttack.j3o");
        
        deathNode = (Node)assetManager.loadModel("Models/Animations/Zombie/kingDeath01/kingDeath.j3o");
        
        standNode = (Node)assetManager.loadModel("Models/Animations/Zombie/kingStand01/kingStand.j3o");
        
        walkNode = (Node)assetManager.loadModel("Models/Animations/Zombie/kingWalk01/kingWalk.j3o");
    }
