...
public class Knight extends PieceAnimation
{
    ...
    protected void loadAnim()
    {
        ...
        attackNode = (Node)assetManager.loadModel("Models/Animations/Zombie/knightAttack01/knightAttack.j3o");
        
        deathNode = (Node)assetManager.loadModel("Models/Animations/Zombie/knightDeath01/knightDeath.j3o");
        
        standNode = (Node)assetManager.loadModel("Models/Animations/Zombie/knightStand01/knightStand.j3o");
        
        walkNode = (Node)assetManager.loadModel("Models/Animations/Zombie/knightWalk01/knightWalk.j3o");
    }
